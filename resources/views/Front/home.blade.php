...
@section('content')
					...
					<!--/tab_one-->
					 ...
					 <!--//tab_two-->
						...
						<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/b1.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/b1.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/b2.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/b2.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/b3.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/b3.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/b4.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/b4.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/b5.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/b5.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/b6.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/b6.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/b7.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/b7.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/b8.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/b8.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
						...
						<div class="tab4">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/s1.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/s1.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/s2.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/s2.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front//s3.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/s3.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/s4.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/s4.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/s5.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/s5.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/s6.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/s6.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/s7.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/s7.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{ asset('asset-front/images/s8.jpg') }}" alt="" class="pro-image-front">
										<img src="{{ asset('asset-front/images/s8.jpg') }}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
            ...
            <div class="banner_bottom_agile_info_inner_w3ls">
    	           <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
						<figure class="effect-roxy">
							<img src="{{ asset('asset-front/images/bottom1.jpg') }}" alt=" " class="img-responsive" />
							<figcaption>
					 ...
					 <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
						<figure class="effect-roxy">
							<img src="{{ asset('asset-front/images/bottom2.jpg') }}" alt=" " class="img-responsive" />
							<figcaption>
								<h3><span>F</span>all Ahead</h3>
								<p>New Arrivals</p>
							</figcaption>			
	...
	<div class="schedule-bottom">
		<div class="col-md-6 agileinfo_schedule_bottom_left">
			<img src="{{ asset('asset-front/images/mid.jpg') }}" alt=" " class="img-responsive" />
		</div>
