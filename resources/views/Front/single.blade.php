...
<div class="banner-bootom-w3-agileits">
	<div class="container">
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="{{ asset('asset-front/images/d2.jpg') }}">
							<div class="thumb-image"> <img src="{{ asset('asset-front/images/d2.jpg') }}" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="{{ asset('asset-front/images/d1.jpg') }}">
							<div class="thumb-image"> <img src="{{ asset('asset-front/images/d1.jpg') }}" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
						<li data-thumb="{{ asset('asset-front/images/d3.jpg') }}">
							<div class="thumb-image"> <img src="{{ asset('asset-front/images/d3.jpg') }}" data-imagezoom="true" class="img-responsive"> </div>
						</li>
					</ul>
					<div class="clearfix"></div>
				</div>	
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
                    <h3>{{ $data->name }}</h3>
                    <?php
                        $fix_price = $data->price - (($data->price * $data->discount) / 100 );
                    ?>
					<p><span class="item_price">Rp {{ $fix_price }}</span> <del>- Rp {{ $data->price }}</del></p>
					<div class="rating1">
					...
					<div class="occasional">
						<h5>Warna :</h5>
						<div class="colr ert">
							<label class="radio"><input type="radio" name="radio" checked=""><i></i>Merah</label>
						</div>
						<div class="colr">
							<label class="radio"><input type="radio" name="radio"><i></i>Biru </label>
						</div>
						<div class="colr">
							<label class="radio"><input type="radio" name="radio"><i></i>Putih</label>
						</div>
						<div class="clearfix"> </div>
					</div>
								...
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
										<div class="bootstrap-tab-text-grid-left">
											<img src="{{ asset('asset-front/images/t1.jpg') }}" alt=" " class="img-responsive">
										</div>
